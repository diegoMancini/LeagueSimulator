...
val ex1 = conditional[String]("Hello", _.size < 10 , _.concat(", World!"))


// 7

//BAD WAY
val ex2 = for (i <- 1 to 100) {
  val a3 = conditional[Int](i, _ % 3 == 0 , x => {println("Type") ;0})
  val a2 = conditional[Int](i, _ % 5 == 0 , x => {println("Safe") ;0})
  val a1 = conditional[Int](i, _ % 15 == 0 , x => {println("TypeSafe") ;0})
